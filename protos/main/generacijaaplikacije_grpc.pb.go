...
type ProfileClient interface {
	...
	SetProfile(ctx context.Context, in *ProfileSet, opts ...grpc.CallOption) (*Empty, error)
...
func (c *profileClient) SetProfile(ctx context.Context, in *ProfileSet, opts ...grpc.CallOption) (*Empty, error) {
	out := new(Empty)
...
type ProfileServer interface {
	...
	SetProfile(context.Context, *ProfileSet) (*Empty, error)
...
func (UnimplementedProfileServer) SetProfile(context.Context, *ProfileSet) (*Empty, error) {
...
func _Profile_SetProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ProfileServer).SetProfile(ctx, req.(*ProfileSet))
	}
	return interceptor(ctx, in, info, handler)
}
